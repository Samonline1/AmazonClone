  ...
  const CategoryOffers = [
    {
      ...
      items: [
        ...
        },
        {
          id: null,
          title: "Skin‑Care",
          img: "https://cdn.dummyjson.com/product-images/skin-care/attitude-super-leaves-hand-soap/1.webp",
          link: "/category/skin-care",
        },
        {
          id: null,
          title: "Womens‑Jewellery",
          img: "https://cdn.dummyjson.com/product-images/womens-jewellery/green-crystal-earring/1.webp",
    ...
    {
      title: "Electronics",
      link: "/category/laptops", // Note: “electronics” isn’t a slug listed — you may map to “smartphones” etc.
      items: [
        {
          id: null,
          title: "Smartphones",
        ...
        },
        {
          id: null,
          title: "Tablets",
          img: "https://cdn.dummyjson.com/product-images/tablets/ipad-mini-2021-starlight/1.webp",
          link: "/category/tablets",
        },
        {
          id: null,
          title: "Mobile-Accessories",
          img: "https://cdn.dummyjson.com/product-images/mobile-accessories/apple-iphone-charger/1.webp",
      ...
      items: [
        {
          ...
          img: "https://cdn.dummyjson.com/product-images/home-decoration/decoration-swing/1.webp",
          link: "/category/home-decoration",
        },
        {
          id: null,
          title: "Kitchen‑Accessories",
          img: "https://cdn.dummyjson.com/product-images/kitchen-accessories/bamboo-spatula/1.webp",
          link: "/category/kitchen-accessories",
        },
        {
          id: null,
          title: "Groceries",
          img: "https://cdn.dummyjson.com/product-images/groceries/apple/1.webp",
      ...
      items: [
        {
          id: null,
          title: "Kitchen‑Accessories",
          img: "https://cdn.dummyjson.com/product-images/kitchen-accessories/boxed-blender/1.webp",
          link: "/category/kitchen-accessories",
        },
        {
          id: null,
        ...
        },
        {
          id: null,
          title: "Smartphones",
          img: "https://cdn.dummyjson.com/product-images/smartphones/iphone-6/1.webp",
          link: "/category/smartphones",
        },
        {
          id: null,
      ...
      items: [
        {
          ...
          img: "https://cdn.dummyjson.com/product-images/womens-dresses/corset-leather-with-skirt/1.webp",
          link: "/category/womens-dresses",
        },
        {
          id: null,
          title: "Womens‑Bags",
          img: "https://cdn.dummyjson.com/product-images/womens-bags/white-faux-leather-backpack/1.webp",
        ...
        },
        {
          id: null,
          title: "Jewellery",
          img: "https://cdn.dummyjson.com/product-images/womens-jewellery/tropical-earring/1.webp",
          link: "/category/womens-jewellery",
        },
      ],
    },
      ...
      items: [
        {
          id: null,
          title: "Sports‑Accessories",
          img: "https://cdn.dummyjson.com/product-images/sports-accessories/american-football/1.webp",
          link: "/category/sports-accessories",
        },
        {
          id: null,
          title: "Sports‑Shoes",
          img: "https://cdn.dummyjson.com/product-images/mens-shoes/sports-sneakers-off-white-&-red/1.webp",
          link: "/category/mens-shoes" /* note: may not exist exactly */,
        },
        {
          id: null,
          title: "Fitness‑Trackers",
          img: "https://cdn.dummyjson.com/product-images/sports-accessories/cricket-helmet/1.webp",
          link: "/category/sports-accessories" /* may need to check slug */,
        },
        {
          id: null,
          title: "Outdoor",
          img: "https://cdn.dummyjson.com/product-images/vehicle/durango-sxt-rwd/1.webp",
          link: "/category/vehicle" /* check slug */,
        },
      ],
    },
    {
      ...
      items: [
        ...
        },
        {
          id: null,
          title: "Cookware",
          img: "https://cdn.dummyjson.com/product-images/groceries/beef-steak/1.webp",
          link: "/category/groceries" /* check slug */,
        },
        {
          id: null,
          title: "Home‑Décor",
          img: "https://cdn.dummyjson.com/product-images/home-decoration/plant-pot/1.webp",
          link: "/category/home-decoration",
        },
        {
          id: null,
          title: "Lighting",
          img: "https://cdn.dummyjson.com/product-images/home-decoration/table-lamp/1.webp",
          link: "/category/home-decoration" /* check slug */,
        },
      ],
    },
  ];
  ...
  return (
    <div className="h-[100vh] w-full h-full overflow-x-hidden box-border flex flex-col items-center">
      <div className="flex w-full  [&::-webkit-scrollbar]:hidden scrollbar-none scroll-Ani ">
        <img
          onClick={() => navigate(`/category/vehicle`)}
          className="w-full"
      ...
      <div className=" absolute bottom-0 h-60 w-full bg-gradient-to-t from-gray-200 to-[rgba(227,230,230]"></div>

      <div className="z-10 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-5 w-[95%] overflow-visible justify-center items-center mt-[-20%]">
        {CategoryOffers &&
          CategoryOffers.map((category, index) => (
            <div key={index} className="w-70 lg:w-full p-5 bg-white text-black">
      ...
      <p className="realtive w-[95%] text-3xl text-black font-bold w-[80%] py-10">
        Products
      </p>

      <div className="grid grid-cols-5 sm:grid-cols-4 lg:grid-cols-6 gap-6 w-[95%] mb-20">
        {products.map((product) => (
          <div
            onClick={() => navigate(`/search/${product.title}/${product.id}`)}
            key={product.id}
            className="h-70 w-40 p-4 bg-white shadow rounded"
          >
            <img
